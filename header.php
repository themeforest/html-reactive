...
<html lang="en">
  <head>
    ...
    <title>Reactive Bootstrap Theme</title>
		...
		<div class="container">
        	...
        	<!-- Collect the nav links, forms, and other content for toggling -->
          		<ul class="nav navbar-nav navbar-left">
            		<li><a href="#"><i class="fa fa-envelope-o"></i> info@vigitalart.com</a></li>
                    <li><a href="javascript:;"><i class="fa fa-phone"></i> +90 212 444 88 77</a></li>
                    <li><a href="javascript:;"><i class="fa fa-map-marker"></i> 12th Street No:12   Taksim / Istanbul</a></li>
          		</ul>
          		...
          		<ul class="nav navbar-nav">
            		<li class="dropdown">
                    	...
                    	<ul class="dropdown-menu">
                        	<li><a href="#">Home Version Slider One</a></li>
                            <li><a href="#">Home Version Slider One</a></li>
                            <li><a href="#">Lorem Ipsum Dolor Sit</a></li>
                        	<li><a href="#">Dolar Sit Amet</a></li>
                        	<li><a href="#">Some Pages Example</a></li>
                    	</ul>
                    </li>
                    <li class="dropdown">
